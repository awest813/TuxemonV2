...
## 2024-05-24 - Provide distinct auditory feedback for rejected inputs
**Learning:** It is an important UX and accessibility pattern to provide distinct auditory feedback for invalid or rejected inputs in custom UI menus.
**Action:** Always verify the menu item's enabled state is True before playing success sounds. If disabled, play an error sound instead to prevent false auditory confirmations.
